...
function sum() {
    ...
    return reduce(arguments, function(a, value) {
      return a + value;
    });
}
...
var results = customers.filter(function(value) {
    return value.first.charAt(0) === 'J'
}).map(function(value, i, ogArray) {
    var newCustomer = value;
    newCustomer.fullname = value.first + " " + value.last;
    return newCustomer
}).sort(function(a, b) {
